...
class stack_answertest_test_data {
    ...
    protected static $rawdata = [
        ...
        // So for now.
        ['AlgEquiv', '', 'single_variable_solver_real(minf <= x)',
            'co(minf,inf)', 1, 'ATRealSet_true.', ''],
        ['AlgEquiv', '', 'single_variable_solver_real(-inf <= x)',
            'co(minf,inf)', 1, 'ATRealSet_true.', ''],
        ['AlgEquiv', '', 'single_variable_solver_real(x <= inf)',
        ...
        ['SubstEquiv', '[x]', 'C1*%e^x*sin(4*x)+C2*%e^x*cos(4*x)+C4*x*%e^-x+C3*%e^-x', 'e^(x)*A*cos(4*x)+B*e^(x)*sin(4*x)+C*e^(-x)+D*x*e^(-x)', 1, 'ATSubstEquiv_Subst [C1 = B,C2 = A,C3 = C,C4 = D].',''],
        ['SubstEquiv', '[x]', 'C1*%e^x*sin(4*x)+C2*%e^x*cos(4*x)+C4*x*%e^-x+C3*%e^-x', 'C4*x*e^(-x)+e^(x)*C1*cos(4*x)+C2*e^(x)*sin(4*x)+C3*e^(-x)', 1, 'ATSubstEquiv_Subst [C1 = C2,C2 = C1,C3 = C3,C4 = C4].',''],
        ['SubstEquiv', '[x]', 'C1*%e^x*sin(4*x)+C2*%e^x*cos(4*x)+C4*x*%e^-x+C3*%e^-x', 'A*x*e^(-x)+e^(x)*B*cos(4*x)+C*e^(x)*sin(4*x)+D*e^(-x)', 1, 'ATSubstEquiv_Subst [C1 = C,C2 = B,C3 = D,C4 = A].',''],
        ['SubstEquiv', '[x]', 'C1*%e^x*sin(4*x)+C2*%e^x*cos(4*x)+C4*x*%e^-x+C3*%e^-x', 'e^(x)*C1*cos(4*x)+C2*e^(x)*sin(4*x)+C3*e^(-x)+C4*x*e^(-x)', 1, 'ATSubstEquiv_Subst [C1 = C2,C2 = C1,C3 = C3,C4 = C4].',''],
