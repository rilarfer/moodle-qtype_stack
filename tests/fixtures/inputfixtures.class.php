...
class stack_inputvalidation_test_data {
    ...
    protected static $rawdata = [
        ...
        ['1E+3', 'php_true', '1E+3', 'cas_true', '1.0E+3', '', "Scientific notation"],
        ['3E2', 'php_true', '3E2', 'cas_true', '3.0E+2', '', ""],
        ['3e2', 'php_true', '3e2', 'cas_true', '3.0E+2', '', ""],
        ['3e-2', 'php_true', '3e-2', 'cas_true', '3.0E-2', '', ""],
        ['3.67x10^2', 'php_true', '3.67*x*10^2', 'cas_true', '3.67\cdot x\cdot 10^2', 'missing_stars', ""],
        ...
        ['[1,2,3.4]', 'php_true', '[1,2,3.4]', 'cas_true', '\left[ 1 , 2 , 3.4 \right]', '', ""],
        ['[x, y, z ]', 'php_true', '[x,y,z]', 'cas_true', '\left[ x , y , z \right]', '', ""],
        ['["a"]', 'php_true', '["a"]', 'cas_true', '\left[ \mbox{a} \right]', '', ""],
        ['[1,true,"a"]', 'php_true', '[1,true,"a"]', 'cas_true', '\left[ 1 , \mathbf{True} , \mbox{a} \right]', '', ""],
        ...
        ['x and y', 'php_true', 'x and y', 'cas_true', 'x\,{\mbox{ and }}\, y', '', ""],
        ['true and false', 'php_true', 'true and false', 'cas_true', '\mathbf{True}\,{\mbox{ and }}\, \mathbf{False}', '', ""],
        ['x or y', 'php_true', 'x or y', 'cas_true', 'x\,{\mbox{ or }}\, y', '', ""],
        ['x xor y', 'php_true', 'x xor y', 'cas_true', 'x\,{\mbox{ xor }}\, y', '', ""],
        ['x nor y', 'php_true', 'x nor y', 'cas_true', 'x\,{\mbox{ nor }}\, y', '', ""],
        ['x nand y', 'php_true', 'x nand y', 'cas_true', 'x\,{\mbox{ nand }}\, y', '', ""],
        ['x implies y', 'php_true', 'x implies y', 'cas_true', 'x\,{\mbox{ implies }}\, y', '', ""],
        ...
        ['x<1 and x>1', 'php_true', 'x < 1 and x > 1', 'cas_true', 'x < 1\,{\mbox{ and }}\, x > 1', '', ""],
        ...
        ['x=1 or 2', 'php_true', 'x = 1 or 2', 'cas_true', 'x=1\,{\mbox{ or }}\, 2', 'Bad_assignment', ""],
        ['x=1 or x=2', 'php_true', 'x = 1 or x = 2', 'cas_true', 'x=1\,{\mbox{ or }}\, x=2', '', ""],
        ...
        ['y^2-2*y-0.5', 'php_true', 'y^2-2*y-0.5', 'cas_true', 'y^2-2\cdot y-0.5', '', ""],
        ...
        ['"WA?@AAA@AA"', 'php_true', '"WA?@AAA@AA"', 'cas_true', '\mbox{WA?@AAA@AA}', '', ""],
    ...
    protected static $rawdataunits = [
        ...
        ['9.81*m/s^2', 'php_true', '9.81*m/s^2', 'cas_true', '9.81\, {\mathrm{m}}/{\mathrm{s}^2}', '', ""],
        ['9.81*m*s^-2', 'php_true', '9.81*m*s^-2', 'cas_true', '9.81\, {\mathrm{m}}/{\mathrm{s}^2}', '', ""],
    ...
    protected static $rawdatadecimals = [
        ...
        [0 => '1.23',
            '.' => [null, 'php_true', '1.23', 'cas_true', '1.23', '', ""],
            ',' => [null, 'php_false', '', '', '', 'forbiddenCharDecimal', ""]
        ],
        [0 => '-1.27',
            '.' => [null, 'php_true', '-1.27', 'cas_true', '-1.27', '', ""],
            ',' => [null, 'php_false', '', '', '', 'forbiddenCharDecimal', ""]
        ],
        [0 => '2.78e-3',
            '.' => [null, 'php_true', '2.78e-3', 'cas_true', '2.78e-3', '', ""],
            ',' => [null, 'php_false', '', '', '', 'forbiddenCharDecimal', ""]
        ],
        [0 => '1,23',
        ...
        [0 => '-1,29',
            '.' => [null, 'php_false', '', '', '', 'unencapsulated_comma', ""],
            ',' => [null, 'php_true', '-1.29', 'cas_true', '-1.29', '', ""]
        ],
        [0 => '2,79e-5',
            '.' => [null, 'php_false', '', '', '', 'unencapsulated_comma', ""],
            ',' => [null, 'php_true', '2.79e-5', 'cas_true', '2.79e-5', '', ""]
        ],
        ...
        [0 => '{1.2,3}',
            '.' => [null, 'php_true', '{1.2,3}', 'cas_true', '\left \{1.2 , 3 \right \}', '', ""],
            ',' => [null, 'php_false', '', '', '', 'forbiddenCharDecimal', ""]
        ],
        [0 => '{1,2;3}',
            '.' => [null, 'php_false', '', '', '', 'forbiddenChar_parserError', ""],
